            ...
            <div className="media text-muted pt-3">
                ...
                <div className="media-body pb-3 mb-0 medium lh-125 border-bottom border-gray text-break" style={{ marginLeft: "1%" }}>
                    ...
                    <div className="media-body" style={{ marginTop: "2%" }}>
                        ...
                        <button type="button" className="btn btn-outline-danger border-white btn-sm CItemButtonRight" onClick={() => this.props.handleRemoveItem(this.props.item.id)}>
                        ...
                        <button type="button" className="btn btn-outline-secondary border-white btn-sm CItemButtonRight" data-toggle="modal" data-target={"#editItemModal" + this.props.item.id}
